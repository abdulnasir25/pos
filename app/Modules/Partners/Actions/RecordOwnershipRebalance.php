 ...
 *
 * Same BEGIN IMMEDIATE reasoning as CreateFinancialPeriod: the
 * "read the active partner set, validate, then write N rows" sequence
 * is only atomic under concurrency if a second concurrent rebalance
 * can't interleave, which plain DB::transaction() doesn't guarantee on
 * SQLite.
 */
